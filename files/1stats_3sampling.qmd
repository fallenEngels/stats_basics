...
ggplot(left_10, aes(x = perc)) + geom_histogram(bins = 5,
  ...
  geom_vline(xintercept = 0.1) + theme_minimal() + 
...
**Source data for this page** can be found <a href="https://github.com/fallenEngels/stats-basics/blob/main/files/1stats_3sampling.qmd">here</a>.
