...
lastmodified = datetime.fromtimestamp(os.stat('3comp_1basics.qmd').st_mtime)
...
**Source data for this page** can be found <a href="https://github.com/fallenEngels/stats-basics/blob/main/files/3comp_1basics.qmd">here</a>.
