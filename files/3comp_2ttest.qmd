...
lastmodified = datetime.fromtimestamp(os.stat('3comp_2ttest.qmd').st_mtime)
...
**Source data for this page** can be found <a href="https://github.com/fallenEngels/stats_basics/blob/main/files/3comp_2ttest.qmd">here</a>.
